#!/usr/bin/env python3
"""
Experiment 8: Gatorade Ad Pipeline — Structured Ads for Beverages

Same architecture as Experiments 6-7 but adapted for Gatorade Thirst Quencher:
- Beverage bottle-specific Gemini prompts (bottles, not watches or cars)
- Futura typography (bold, athletic, Gatorade's energy)
- Condensed ExtraBold headlines, punchy CTA buttons

Usage: python3 generate.py campaigns/gatorade.json
"""
