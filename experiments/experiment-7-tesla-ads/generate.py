#!/usr/bin/env python3
"""
Experiment 7: Tesla Ad Pipeline — Structured Ads for Automotive

Same architecture as Experiment 6 but adapted for Tesla Model S:
- Automotive-specific Gemini prompts (cars, not watches)
- Helvetica Neue typography (Tesla's minimal aesthetic)
- Wider margins, more breathing room, letter-spaced brand name

Usage: python3 generate.py campaigns/tesla.json
"""
