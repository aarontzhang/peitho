#!/usr/bin/env python3
"""
Experiment 10: Water Bottle Ad Pipeline — Splash Backgrounds

Same architecture as Experiments 6-8 but adapted for an insulated water bottle:
- Water splash background prompts via Gemini (Nano Banana 2)
- Futura typography (bold, active aesthetic)
- Stacked layout: brand/product top, bottle+splash center, headline+CTA bottom

Usage: python3 generate.py campaigns/waterbottle.json
"""
...
def main():
    ...
    for i, icp in enumerate(icps, 1):
        ...
        # Step 1: Generate product image via Gemini (Nano Banana)
